...
recognition.onresult = function (event) {
  ...
  // }
    ...
    outputMessage('add ons are skipped, you can add accessories in your cart page also')
  }
  ...
  // }
    ...
    outputMessage('default credit card is selected, please review billing and shipping address and continue')
  }
    ...
    outputMessage('please select any one payment method to continue')
  }
    ...
    outputMessage('Hurray!!! your order is placed successfully. we hope you had a great shopping experience. The product would arrive as early as possible. Thank you very much, have a great day')
      ...
      if ((productName.toLowerCase()).includes(transcript.toLowerCase())) {
        ...
        for (let j = 0; j < aTags.length; j++) {
          ...
          if (modelName != null && aTags[j].getAttribute(attributeName) != null && (aTags[j].getAttribute(attributeName).toLowerCase()).includes(modelName.toLowerCase())) {
            ...
            outputMessage('please select your carrier, capacity, colour and continue')
          }
        }
      }
    }
