...
recognition.onend = function () {
  alert("Samsung voice recognition is paused. Click allow to start again !!!");
  // outputMessage("Samsung voice recognition is paused. Click allow to start again !!!")
  recognition.start();
};
...
recognition.onresult = function (event) {
  ...
  if (transcript == "hello samsung") {
    outputMessage("Hello Customer. Welcome to Samsung. Enjoy your shopping. Please tell your product name");
    ...
    outputMessage("cart page. your selected products are listed here")
  }
    ...
    outputMessage(`capacity ${phone} is selected`)
  }
    ...
    phone = phone.join("-")
    document.getElementById(phone).click();
    outputMessage(`colour ${phone} is selected`)
    ...
    phone = phone.join("-")
    document.getElementById(phone).click();
    outputMessage(`carrier ${phone} is selected`)
  }
  ...
  // else if (transcript == "update and continue") {
  // }
  else if (transcript == "skip add ons") {
    document.getElementsByClassName("palette-btn")[0].click();
    outputMessage('add ons are skipped. do you really want to continue. you can add accessories in the cart page also')
  }
  ...
  // }
    ...
    outputMessage('default credit card is selected, please review your billing and shipping address and continue')
  }
    ...
    outputMessage('please select any one of the payment methods to continue')
  }
    ...
    outputMessage('Hurray. Your order is placed successfully. we hope you had a great shopping experience.The product will arrive as early as possible.Thank you for your order.Have a great day')
      ...
      if ((productName.toLowerCase()).includes(transcript.toLowerCase())) {
        ...
        for (let j = 0; j < aTags.length; j++) {
          ...
          if (modelName != null && aTags[j].getAttribute(attributeName) != null && (aTags[j].getAttribute(attributeName).toLowerCase()).includes(modelName.toLowerCase())) {
            ...
            outputMessage('please select your carrier, capacity, colour in the next page to continue')
          }
        }
      }
    }
    ...
    outputMessage(`please select your ${transcript} from the list available`)
  }
