...
recognition.onresult = function (event) {
  ...
  if (transcript == "hello samsung") {
    ...
    if (document.getElementsByClassName("btn btn-primary btn-rounded")[2]) {
      ...
      outputMessage('please select your required delivery mode and continue')
    }
  }
  ...
  // }
    ...
    outputMessage('Hurray..... Your order is placed successfully. hope you had a great shopping experience. Have a great day')
  }
    ...
    outputMessage(`fetching the list of ${transcript} products`)
  }
