...
recognition.onresult = function (event) {
  ...
  if (transcript == "hello samsung") {
    ...
    else if (document.getElementsByClassName("btn-primary")[0])
      document.getElementsByClassName("btn-primary")[0].click();
    else if (document.getElementsByClassName("btn btn-primary btn-rounded")[0])
      document.getElementsByClassName("btn btn-primary btn-rounded")[0].click();
  }
