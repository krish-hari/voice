...
recognition.onend = function () {
  ...
  // await outputMessage("Samsung voice recognition is paused. Click allow to start again !!!")
  recognition.start();
};
...
recognition.onresult = async function (event) {
  ...
  if (transcript == "hello samsung") {
    ...
    if (document.getElementsByClassName("btn btn-primary btn-rounded")[2]) {
      ...
      await outputMessage('please select your required delivery mode and continue')
    }
  }
